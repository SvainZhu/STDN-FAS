...
class Dataset_Csv_unpair(data.Dataset):
    def __init__(self, opts):
        self.csvroot_a = opts.csvroot_a
        self.csvroot_b = opts.csvroot_b

        # A
        frame_reader = open(opts.csvroot_a, 'r')
        csv_a = csv.reader(frame_reader)
        self.A = [item[0] for item in csv_a]

        # B
        frame_reader = open(opts.csvroot_b, 'r')
        csv_b = csv.reader(frame_reader)
        self.B = [item[0] for item in csv_b]
