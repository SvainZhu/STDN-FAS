...
#
#         self.layer4 = nn.Sequential(
#             RGC(128, 256, kernel_size=3, stride=2, padding=1, bias=False),
#             nn.BatchNorm2d(256),
#             nn.ReLU(inplace=True)
#         )
#
...
#
#         self.ada_conv1 = nn.Sequential(
#             RGC(128, 128, kernel_size=3, stride=2, padding=1, bias=False),
#             nn.InstanceNorm2d(128),
#             nn.ReLU(inplace=True)
#         )
#
...
#         self.decoder = nn.Sequential(
#             nn.Upsample(scale_factor=2, mode='bilinear'),
#             RGC(512, 128, kernel_size=3, stride=1, padding=1, bias=False),
#             nn.BatchNorm2d(128),
#             nn.ReLU(inplace=True),
#
#             nn.Upsample(scale_factor=2, mode='bilinear'),
#             RGC(128, 64, kernel_size=3, stride=1, padding=1, bias=False),
#             nn.BatchNorm2d(64),
#             nn.ReLU(inplace=True),
#
#             RGC(64, 1, kernel_size=3, stride=1, padding=1, bias=False),
#             nn.ReLU(inplace=True)
#         )
#
#     def cal_gamma_beta(self, x1):
