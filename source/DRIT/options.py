...
class TrainOptions():
    def __init__(self):
        ...
        # data loader related
        self.parser.add_argument('--csvroot_a', type=str, default=r'E:\zsw\Data\OULU\CSV_rsf\2.0\train_1_6.csv',
                                 help='path of csv_a')
        self.parser.add_argument('--csvroot_b', type=str, default=r'E:\zsw\Data\CASIA_FASD\CSV_rsf\2.0\train_1_6.csv',
                                 help='path of csv b')
        ...
        self.parser.add_argument('--nThreads', type=int, default=12, help='# of threads for data loader')
