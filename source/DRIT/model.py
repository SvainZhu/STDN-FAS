...
class DRIT(nn.Module):
    ...
    def update_D(self, image_a, image_b):
        ...
        if not self.no_ms:
            ...
            self.disA2_loss = loss_D2_A2.item() + self.disA2_loss
        self.disA2_opt.step()
        ...
        if not self.no_ms:
            ...
            self.disB2_loss = loss_D2_B2.item() + self.disB2_loss
        self.disB2_opt.step()
    ...
    def backward_D(self, netD, real, fake):
        ...
        for it, (out_a, out_b) in enumerate(zip(pred_fake, pred_real)):
            ...
            loss_D = ad_true_loss + ad_fake_loss + loss_D
        loss_D.backward()
        return loss_D
    ...
    def backward_G_GAN(self, fake, netD=None):
        ...
        for out_a in outs_fake:
            ...
            loss_G = nn.functional.binary_cross_entropy(outputs_fake, all_ones) + loss_G
        return loss_G
    ...
    def backward_G_alone(self):
        ...
        if not self.no_ms:
            loss_z_L1 = loss_G_GAN2_A2 + loss_G_GAN2_B2 + loss_z_L1
            loss_z_L1 = loss_lz_AB + loss_lz_BA + loss_z_L1
        # loss_z_L1.backward()
